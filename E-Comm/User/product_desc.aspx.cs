...
public partial class User_product_desc : System.Web.UI.Page
{
    ...
    protected void b1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                Response.Cookies["aa"].Value = Request.Cookies["aa"].Value + "|" + product_name.ToString() + "," + product_desc.ToString() + "," + product_price.ToString() + "," + t1.Text.ToString() + "," + product_images.ToString() + "," + id.ToString();
