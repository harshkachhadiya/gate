...
<asp:Content ID="Content1" ContentPlaceHolderID="c1" Runat="Server">
       ...
       <asp:Repeater ID="d1" runat="server">
        ...
        <ItemTemplate>
         ...
         item_name=<%#Eval("product_name") %><br />product_desc=<%#Eval("product_desc") %><br />product_price=<%#Eval("product_price") %><br />product_qty=<%#Eval("product_qty") %><br /></div>
      </div>
      ...
      <br />
       <table>
           <tr>
               <td>  <asp:Label ID="l2" runat="server" ForeColor="Red" Text="Enter Quantity:-"> </asp:Label>
                 </td>
        <td> <asp:TextBox ID="t1" runat="server" > </asp:TextBox> </td>
               <td><asp:Button ID="b1" runat="server" Text="Add to Cart" OnClick="b1_Click" />
     </td>
            </tr>
           <tr>
               <td colspan="3">
